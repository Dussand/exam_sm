...
C2023II = pd.read_csv('/workspaces/exam_sm/postulantes_por_carrera2023II.csv')
C2024I = pd.read_csv('/workspaces/exam_sm/postulantes_por_carrera2024I.csv')
C2024II = pd.read_csv('/workspaces/exam_sm/postulantes_por_carrera2024II.csv')
C2025I = pd.read_csv('/workspaces/exam_sm/postulantes_por_carrera2025I.csv')
areas_sm = pd.read_csv('/workspaces/exam_sm/areas_sanmarcos')
